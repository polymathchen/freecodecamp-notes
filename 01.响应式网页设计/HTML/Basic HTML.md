...
###  开放图谱标签的作用
 开放图谱协议使你能够控制网站内容在各种社交媒体平台（如 Facebook， LinkedIn 等）上的显示方式。 通过设置这些开放图谱属性，你可以吸引用户点击并参与你的内容
...
## 使用图像和 SVG
 获得版权所有者的书面许可，从版权所有者那里购买许可证，或者以一种属于合理使用的方式合并图像
 PNG 和 JPG 等常见图像格式属于光栅格式。 这本质上意味着它们是基于像素的，数据跟踪每个像素的颜色值。
